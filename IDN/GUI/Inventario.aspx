<%@ Page Title="" Language="C#" MasterPageFile="~/GUI/IDNMaster.master" AutoEventWireup="true" CodeFile="Inventario.aspx.cs" Inherits="GUI_Inventario" %>
                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        ...
                                        <div class="form-group">
                                            <div class="col-lg-3">
                                                <div class="col-md-12">
                                                    <label class="color-label">Destino:</label>
                                                </div>
                                                <div class="input-group">
                                                    <span class="input-group-btn">
                                                        <button class="btn btn-default" type="button">Destino</button>
                                                    </span>

<%@ Page Title="" Language="C#" MasterPageFile="~/GUI/IDNMaster.master" AutoEventWireup="true" CodeFile="SalidaGarantia.aspx.cs" Inherits="GUI_SalidaGarantia" %>
                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-3">
                                                <div class="col-md-12">
                                                    <label class="color-label">Salida garantía:</label>
                                                </div>
                                    ...
                                    <div class="row">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12" id="top-btnInfo">
                                                <button class="btn btn-info pull-right">Imprimir salida garantía</button>
                                            </div>
